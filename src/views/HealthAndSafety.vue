  ...
  <div class="safety-page-wrap">
    ...
    <div class="safety-contents">
      <section class="first">
        ...
        <div>
          <p>       
            LoveNest aides are provided with any PPE needed to safely care for clients:
          </p>
          <p>
            <ul>
              <li>
          ...
          <p>       
            LoveNest aides are trained in the most effective methods of disease and infection control.
          </p>
        </div>
      </section>
